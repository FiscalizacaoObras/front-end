  ...
  return (
    <div className="flex flex-wrap gap-8 justify-center p-6">
      {templates.map((template) => (
        <div
          key={template.id}
          className="w-[40vh] h-[40vh] flex flex-col items-center justify-start border-2 border-[#602E31] rounded-lg bg-white hover:shadow-md transition-all duration-200"
        >
          <div className="flex h-[45%] w-full bg-[#602E31] rounded-t-md"></div>
